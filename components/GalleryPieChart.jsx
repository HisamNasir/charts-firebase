    ...
    if (currentUser) {
      ...
      getDocs(q)
        .then((querySnapshot) => {
          ...
          const categoryDataArray = Object.entries(categoryCount).map(([category, count]) => ({
            category,
            count,
          }));
  ...
  return (
      <div className='p-4 w-full'>
        <div className='bg-blue-100 dark:bg-gray-800 w-full p-4 rounded-xl'>
          <h1 className='text-3xl font-semibold mb-4 text-center'>Image Gallery</h1>
          <p className=' text-center opacity-60'>Images Uploaded Today: {imagesUploadedToday}</p>
          {imageData.length === 0 ? (
            <p>No images found.</p>
          ) : (
            <div className='w-full'>
              ...
              <div className='p-4'>
  <h2 className='text-2xl font-semibold text-center my-4'>Image Data</h2>
  <div className=''>
    <table className='table-auto w-full'>
      ...
      <tbody>
        {imageData.map((data, index) => (
          <tr key={index} className={index % 2 === 0 ? 'bg-gray-300 bg-opacity-20' : 'bg-gray-200 bg-opacity-20'}>
...
<div className='p-4 border border-gray-500 rounded-xl mt-4'>
  <h2 className='text-2xl font-semibold text-center my-4'>Category Counts</h2>
  <div className=''>
    <table className='table-auto w-full'>
      <thead>
        <tr className='bg-blue-100 dark:bg-gray-700'>
